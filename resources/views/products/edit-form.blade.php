...
<div class="container">
    ...
    <form action="{{ route('products.update', $product->code) }}" method="post" class="search-form">
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" class="price-input" value="{{ $product->name }}" required>
        </div>

        <div class="form-group">
            <label for="price">Price</label>
            <input type="number" id="price" step="any" name="price" class="price-input" value="{{ $product->price }}" required>
        </div>
