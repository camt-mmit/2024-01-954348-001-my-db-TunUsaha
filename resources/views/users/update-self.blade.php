    ...
    <div class="container">
        ...
        <form action="{{ route('users.update-self-submit', $user->id) }}" method="post" class="search-form">
            ...
            <div class="form-group">
                ...
                <input type="text" id="email" name="email" class="price-input" value="{{ $user->email }}" required>
            </div>

            <div class="form-group">
                <label for="name">Name</label>
                <input type="text" id="name" name="name" class="price-input" value="{{ $user->name }}" required>
            </div>
