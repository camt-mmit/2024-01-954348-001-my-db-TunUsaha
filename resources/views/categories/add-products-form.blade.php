...
@section('content')
<a href="{{ route('categories.view-products', ['category' => $category->code]) }}" class="back-button" aria-label="ย้อนกลับ">
...
<div class="content-wrapper">
    ...
    <form action="{{ route('categories.add-products-form', ['category' => $category->code]) }}" method="get" class="search-form">
        ...
        <div class="button-group">
            ...
            <a href="{{ route('categories.add-products-form', ['category' => $category->code]) }}" class="secondary-button">Clear</a>
        </div>
    </form>
    <form action="{{ route('categories.add-product', ['category' => $category->code]) }}" method="post" class="mt-6">
        @csrf
