...
<div class="container">
    ...
    <form action="{{ route('shops.update', $shop->code) }}" method="post" class="search-form">
        ...
        <div class="form-group">
            ...
            <input type="text" id="name" name="name" class="price-input" value="{{ $shop->name }}" required>
        </div>

        <div class="form-group">
            <label for="owner">Owner</label>
            <input type="text" id="owner" name="owner" class="price-input" value="{{ $shop->owner }}" required>
        </div>

        <div class="form-group">
            <label for="latitude">Latitude</label>
            <input type="number" id="latitude" step="any" name="latitude" class="price-input" value="{{ $shop->latitude }}" required>
        </div>

        <div class="form-group">
            <label for="longitude">Longitude</label>
            <input type="number" id="longitude" step="any" name="longitude" class="price-input" value="{{ $shop->longitude }}" required>
        </div>
